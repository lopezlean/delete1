 ...
 * @example
 * ```js
 * const path1 = getPath( 'https://lopezlean.github.io/delete1:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString = getQueryString( 'https://lopezlean.github.io/delete1:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
 * ```
 *
 ...
 * @example
 * ```js
 * const pathAndQueryString1 = getPathAndQueryString( 'https://lopezlean.github.io/delete1:8080/this/is/a/test?query=true' ); // '/this/is/a/test?query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'https://lopezlean.github.io/delete1:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
 ...
 * @example
 * ```js
 * const filename1 = getFilename( 'https://lopezlean.github.io/delete1:8080/this/is/a/test.jpg' ); // 'test.jpg'
